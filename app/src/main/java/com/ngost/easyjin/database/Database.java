 ...
 */
package com.ngost.easyjin.database;
...
import com.ngost.easyjin.Alarm.Difficulty;
import com.ngost.easyjin.Alarm.Alertway;
...
public class Database extends SQLiteOpenHelper {
	...
	public static final String COLUMN_ALARM_ALERTWAY = "alarm_alertway";
	...
	public static long create(Alarm alarm) {
		...
		cv.put(COLUMN_ALARM_ALERTWAY, alarm.getAlertway().ordinal());
	...
	public static Alarm getAlarm(int id) {
		...
		if(c.moveToFirst()){
			...
			alarm.setAlertway(Alertway.values()[c.getInt(9)]);
		}
		c.close();
		return alarm;
	}
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS " + ALARM_TABLE + " ( " 
				...
				+ COLUMN_ALARM_NAME + " TEXT NOT NULL, "
	 			+ COLUMN_ALARM_ALERTWAY + " INTEGER NOT NULL)");
	}
	...
	public static List<Alarm> getAll() {
		...
		if (cursor.moveToFirst()) {
			...
			do {
				...
				alarm.setAlertway(Alertway.values()[cursor.getInt(8)]);
				alarms.add(alarm);
